import {
  ROUTE_BASIC_FETCH, ROUTE_BASIC_STATE, ROUTE_INTER_FETCH, ROUTE_INTER_STATE, ROUTE_DELETE_STATE,
} from './constants';
...
export default {
  ...
  [ROUTE_DELETE_STATE]: [{ id: 1, text: 'Не знаешь с чего начать? Попробуй вдохновится  <a target="_blank" href="https://habr.com/ru/company/hh/blog/352150/">статьей</a>' }, { id: 2, text: 'Ты можешь изменить значения в state так, чтобы они были объектами с id - так будет проще' }],
