...
export default {
  ...
  [ROUTE_BASIC_FETCH]: [{ id: 1, text: 'Не забывай про dependency array (он должен хотя бы быть)' }, { id: 2, text: 'Если пишешь fetch с помощью async/await делай через IIFE' }, { id: 3, text: 'Если у тебя "name" of null или undefined - вспомни про &&' }],
